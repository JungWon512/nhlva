	...
	<div class="search-area">
		<div class="search-box">
			...
			<div class="sort">
				...
				<c:forEach items="${etcList}" var="evo" varStatus="i">
					<option id="ra${evo}" value="${evo}" <c:if test="${inputParam.searchAucObjDsc eq evo}">selected</c:if>>${etcNmList[i.index]}</option>  
				</c:forEach>
				</c:if>
				</select>	
			</div>
