...
<div class="auction_list">
	...
	<div class="auction_area">
		...
		<div class="calculator_head_pc">
			<dl>
				<dt>${johapData.CLNTNM}<span>|</span>참가번호 <b class="join-num" style="font-weight:700;"></b></dt>
				<dd>
					<div class="auc-txt">
						...
						<li class="boarder">
							...
							<div class="mo_seeBox">
								<ul>
									...
									<li class="harf-list" style="display:none;">
										<dl>
											<dt>지역명</dt>
											<dd>
												<p class="sraPdRgnnm move-txt" style="width:150px"></p>
											</dd>
										</dl>
									</li>
								</ul>
		...
		<div class="auction_calculator">
			<div class="calculator_top">
				<div class="auc-txt">
					...
					<div class="message_board" style="min-height:37px;display:none;"></div>
					<a href="javascript:;" class="pop-btn btn_popup">팝업</a>
				</div>
				<dl class="auctionNum">
					<dt>경매<br/>번호</dt>
					<dd><input type="text" class="auctionNum active" id="auction_num" name="auctionNum" placeholder="0" readonly /></dd>
				</dl>
			...
			<div class="calculator_bottom">
				...
				<ul class="calculator-cell btn-summit">
					<li class="auctionNum"><button class="num_summit btn_confirm">확인</button></li>
