...
<style>
	...
	.billboard-view .countVer .brandTit p{text-align: left;font-size: 85px;letter-spacing: -5px;}
	.billboard-view .countVer .secTxt{height: 34%;background-color: #3b3b3b;}
	.billboard-view .countVer .secTxt p{font-size: 115px;letter-spacing: -7.5px;}
	.billboard-view .countVer .countTxt{height: 56%;padding:  0px;}
	.billboard-view .countVer .countTxt p{font-size: 445px;color: #ffd500;font-family: 'LAB디지털';letter-spacing: 50px;}
</style>
