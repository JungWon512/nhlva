	...
	<div class="sum_table">
		<div>
			...
			<dl>
				<dt><p>암</p></dt>
				<dd>
					<p class="cowCnt"><span class="ea">${empty buyCnt.CNT_SEX_W? '0' : buyCnt.CNT_SEX_W}</span>두</p>
				</dd>
			</dl>
			<dl>
				<dt><p>수</p></dt>
				<dd>
					<p class="cowCnt"><span class="ea">${empty buyCnt.CNT_SEX_M? '0' : buyCnt.CNT_SEX_M }</span>두</p>
				</dd>
			</dl>
			<dl>
				<dt><p>기타</p></dt>
				<dd>
					<p class="cowCnt"><span class="ea">${empty buyCnt.CNT_SEX_ETC? '0' : buyCnt.CNT_SEX_ETC}</span>두</p>
				</dd>
			</dl>
		</div>
	</div>
