		...
		<div class="modal-content">
			...
			<div class="pop_TermsBox mCustomScrollBox">
				<p>
					...
					④ 경매낙찰 후 개설자가 정한 기일 이내 경매진행시 공지하지 않은 하자가 발생하여 매수인이 이의를 제기하는 경우 매수인은 매도인(출하주)과 협의하여 가격을 조정하거나 반송할 수 있으며, 그에 따른 비용은 협의하여 정할 수 있다. 가격조정이 안 될 경우 개설자는 운영협의회를 통하여 가격을 조정하거나 반송 등을 할 수 있다. 단, 하자 내용을 경매 전 고지하여 이를 알고 거래된 개체와 수송 스트레스나 매수자 과실로 인한 하자는 이의제기를 할 수 없다.<br/>
				</p>
			</div>
		</div>
		<!-- //modal-content e -->
		...
		<div class="modal-content">
			...
			<div class="pop_TermsBox mCustomScrollBox">
				<p>
					...
					이 개인정보처리방침은 2021년 10월 8일로부터 적용되며, 법령 및 방침에 따른 변경내용의 추가, 삭제 및 정정이 있는 경우에는 변경사항의 시행 7일 전부터 공지사항을 통하여 고지할 것입니다.<br/>
					개정일자 : 2021년 10월 7일
				</p>
			</div>
		</div>
