...
<section class="contents" style="margin: 0px 40px;">
	<h3 style="margin: 0px 24px; font-weight: 700; font-size: 20px;">이용약관
		2021.06.20</h3>
	<br />
	...
	<div class="terms_area">
		<ul class="past-terms">
			<li>2022.09.17 이용약관 <a
				href="javascript:pageMove('/agreement/220917');" id="20220917">[변경내용보기]</a></li>
			<li>2021.06.20 이용약관 <a
				href="javascript:pageMove('/agreement/210620');" id="20210620">[변경내용보기]</a></li>
		</ul>
	</div>
</section>
