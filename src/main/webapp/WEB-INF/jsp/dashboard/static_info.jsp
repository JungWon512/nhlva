...
<input type="hidden" id="naBzplcloc" value="${loginJohapData.NA_BZPLCLOC }"/>
...
<div class="board-new">
	...
	<div class="box-select ver-date">
		<div>
			<input type="text" name="stSearchDt" id="stSearchDt" value="">	
		</div>
		<div>
			<input type="text" name="edSearchDt" id="edSearchDt" value="">
		</div>
	</div>
